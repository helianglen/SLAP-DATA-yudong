!SUBROUTINE sea_water 

! Purpose :
!   Calculate sea water  emissivity 
! Interface :
! ---------
! Reference : CMEM
! ---------
...
subroutine sea_water(fghz, theta, tsurf, sal_water, &
                     water_em, tb_water)

implicit none

real :: fghz, theta, tsurf, sal_water, water_em(2), tb_water(2)
