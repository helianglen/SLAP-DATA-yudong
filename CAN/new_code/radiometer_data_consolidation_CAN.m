...
%YDT fix non-monotonic increasing issue. 
eqind=find(diff(timeMotAll)<=0); 
timeMotAll((eqind+1)) = 0.5*(timeMotAll(eqind) + timeMotAll(eqind+2));  

% interpolation is done there 
